...
exports.checkForUpdate = function(callback) {
	request("https://raw.githubusercontent.com/PrimalMew/HypeBot/master/package.json", function(err, response, body) {
		if (err) {
		...
		if (response.statusCode == 200) {
			...
			return callback("HypeBot.EXE's version is up-to-date (v" + version + ")");
		} else {
